...
=======
call_function  _new_var        <function _new_var at 0x7013f8a71300>      (arg0_1,)                                                   {}
call_function  out             <function _host_tensor at 0x7013f8acf740>  ('out',)                                                    {}
call_function  sym_size_int    aten.sym_size.int                          (arg0_1, 0)                                                 {}
call_function  sym_size_int_1  aten.sym_size.int                          (arg0_1, 1)                                                 {}
call_function  atomic_add      <function atomic_add at 0x70140452c9a0>    (out, [sym_size_int, sym_size_int_1], _new_var, 'relaxed')  {}
>>>>>>> 9d712d2 (fix the tensor dimension determination process when calling torch-mlir to get exact shapes from Helion's device IR, updated examples)
...
=======
call_function  a             <function _host_tensor at 0x7013f8acf740>  ('a',)                                         {}
call_function  block_size_0  <function _get_symnode at 0x7013f8ace660>  ('block_size_0',)                              {}
call_function  block_size_2  <function _get_symnode at 0x7013f8ace660>  ('block_size_2',)                              {}
call_function  load          <function load at 0x70135357ec00>          (a, [block_size_0, block_size_2], None, None)  {}
call_function  b             <function _host_tensor at 0x7013f8acf740>  ('b',)                                         {}
call_function  block_size_1  <function _get_symnode at 0x7013f8ace660>  ('block_size_1',)                              {}
call_function  load_1        <function load at 0x70135357ec00>          (b, [block_size_2, block_size_1], None, None)  {}
call_function  acc           aten.mm.default                            (load, load_1)                                 {}
call_function  tile_begin    <function tile_begin at 0x70135359e7a0>    (block_size_2,)                                {}
call_function  eq_2          <built-in function eq>                     (tile_begin, 0)                                {}
call_function  _if           <function _if at 0x7013f8acfec0>           (eq_2, 0, [acc])                               {}
>>>>>>> 9d712d2 (fix the tensor dimension determination process when calling torch-mlir to get exact shapes from Helion's device IR, updated examples)
