...
call_function  _new_var        <function _new_var at 0x7fc7957c80d0>      (arg0_1,)                                                   {}
call_function  out             <function _host_tensor at 0x7fc7957967a0>  ('out',)                                                    {}
call_function  sym_size_int    aten.sym_size.int                          (arg0_1, 0)                                                 {}
call_function  sym_size_int_1  aten.sym_size.int                          (arg0_1, 1)                                                 {}
call_function  atomic_add      <function atomic_add at 0x7fc7a01b1e10>    (out, [sym_size_int, sym_size_int_1], _new_var, 'relaxed')  {}
output         output          output                                     ([],)                                                       {}
Graph 1: RootGraphInfo
opcode         name          target                                     args                                           kwargs
-------------  ------------  -----------------------------------------  ---------------------------------------------  --------
call_function  a             <function _host_tensor at 0x7fc7957967a0>  ('a',)                                         {}
call_function  block_size_0  <function _get_symnode at 0x7fc795795b40>  ('block_size_0',)                              {}
call_function  block_size_2  <function _get_symnode at 0x7fc795795b40>  ('block_size_2',)                              {}
call_function  load          <function load at 0x7fc786a72320>          (a, [block_size_0, block_size_2], None, None)  {}
call_function  b             <function _host_tensor at 0x7fc7957967a0>  ('b',)                                         {}
call_function  block_size_1  <function _get_symnode at 0x7fc795795b40>  ('block_size_1',)                              {}
call_function  load_1        <function load at 0x7fc786a72320>          (b, [block_size_2, block_size_1], None, None)  {}
call_function  acc           aten.mm.default                            (load, load_1)                                 {}
call_function  tile_id       <function tile_id at 0x7fc786a927a0>       (block_size_2,)                                {}
call_function  eq_2          <built-in function eq>                     (tile_id, 0)                                   {}
call_function  _if           <function _if at 0x7fc795796e60>           (eq_2, 0, [acc])                               {}
output         output        output                                     (None,)                                        {}


=== Nodes with symbols ===
Node arg0_1 : FakeTensor(..., size=(u0, u1), dtype=torch.float16)
Node _new_var : FakeTensor(..., size=(u0, u1), dtype=torch.float16)
Node out : FakeTensor(..., size=(s97, s20), dtype=torch.float16)
Node sym_size_int : u0
Node sym_size_int_1 : u1
Node atomic_add : FakeTensor(..., size=(u0, u1), dtype=torch.float16)
...
Node acc : FakeTensor(..., size=(u0, u1), dtype=torch.float16)
Node tile_id : u3
Node eq_2 : Eq(u3, 0)
Node _if : []
...
module attributes {loom.tile_k = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_m = {is_reduction = false, upper_bound = 512 : index}, loom.tile_n = {is_reduction = false, upper_bound = 512 : index}} {
  func.func @split_k_matmul(%arg0: memref<512x512xf16>, %arg1: memref<512x4096xf16>, %arg2: memref<4096x512xf16>) {
    %c0 = arith.constant 0 : index
    %cst = arith.constant 0.000000e+00 : f16
    %c4096 = arith.constant 4096 : index
    %c512 = arith.constant 512 : index
    %0 = "loom.sym"() {is_reduction = false, symbol_ref = @tile_m, upper_bound = 512 : index} : () -> index
    %1 = "loom.sym"() {is_reduction = false, symbol_ref = @tile_n, upper_bound = 512 : index} : () -> index
    ...
    affine.parallel (%arg3, %arg4, %arg5) = (0, 0, 0) to (symbol(%3), symbol(%4), symbol(%5)) {
      ...
      %subview_0 = memref.subview %arg2[%7, %9] [%2, %1] [1, 1] : memref<4096x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
      %10 = bufferization.to_tensor %subview_0 : memref<?x?xf16, strided<[512, 1], offset: ?>> to tensor<?x?xf16>
      ...
      scf.if %14 {
        %subview_1 = memref.subview %arg0[%6, %9] [%0, %1] [1, 1] : memref<512x512xf16> to memref<?x?xf16, strided<[512, 1], offset: ?>>
        "loom.sum"(%subview_1, %13) : (memref<?x?xf16, strided<[512, 1], offset: ?>>, tensor<?x?xf16>) -> ()
      }
    }
    return
  }
