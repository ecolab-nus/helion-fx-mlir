...
call_function  _new_var        <function _new_var at 0x7f2718375360>      (arg0_1,)                                                                    {}
call_function  _new_var_1      <function _new_var at 0x7f2718375360>      (arg1_1,)                                                                    {}
call_function  _new_var_2      <function _new_var at 0x7f2718375360>      (arg2_1,)                                                                    {}
call_function  _new_var_3      <function _new_var at 0x7f2718375360>      (arg3_1,)                                                                    {}
call_function  _new_var_4      <function _new_var at 0x7f2718375360>      (arg4_1,)                                                                    {}
call_function  k_view          <function _host_tensor at 0x7f271836ba30>  ('k_view',)                                                                  {}
call_function  sym_size_int    aten.sym_size.int                          (arg0_1, 0)                                                                  {}
call_function  block_size_3    <function _get_symnode at 0x7f271836add0>  ('block_size_3',)                                                            {}
call_function  k               <function load at 0x7f26ff7e75b0>          (k_view, [sym_size_int, slice(None, None, None), block_size_3], None, None)  {}
call_function  sym_size_int_1  aten.sym_size.int                          (arg0_1, 1)                                                                  {}
call_function  qk              aten.bmm.default                           (_new_var, k)                                                                {}
call_function  _mask_to_2      <function _mask_to at 0x7f2718375000>      (qk, -inf)                                                                   {}
...
call_function  m_ij_broad      <function broadcast at 0x7f26ff5a9480>     (m_ij, 2, [sym_size_int, sym_size_int_1, block_size_3])                      {}
...
call_function  _mask_to_3      <function _mask_to at 0x7f2718375000>      (exp, 0)                                                                     {}
...
call_function  v_view          <function _host_tensor at 0x7f271836ba30>  ('v_view',)                                                                  {}
call_function  v               <function load at 0x7f26ff7e75b0>          (v_view, [sym_size_int, block_size_3, slice(None, None, None)], None, None)  {}
call_function  acc_1           aten.baddbmm.default                       (acc, _mask_to_3, v)                                                         {}
call_function  m_i             <function _new_var at 0x7f2718375360>      (m_ij,)                                                                      {}
output         output          output                                     ([m_i, l_i, acc_1],)                                                         {}
Graph 1: RootGraphInfo
opcode         name           target                                     args                                                                         kwargs
-------------  -------------  -----------------------------------------  ---------------------------------------------------------------------------  ----------------------------------------------------------------------------------------------------
call_function  qk_scale_dev   <function full at 0x7f26ff7d6dd0>          ([], 0.08838834764831843, torch.float16, None)                               {}
call_function  block_size_0   <function _get_symnode at 0x7f271836add0>  ('block_size_0',)                                                            {}
call_function  block_size_1   <function _get_symnode at 0x7f271836add0>  ('block_size_1',)                                                            {}
call_function  m_i            <function full at 0x7f26ff7d6dd0>          ([block_size_0, block_size_1, 1], -inf, torch.float16, None)                 {}
...
call_function  acc            <function full at 0x7f26ff7d6dd0>          ([block_size_0, block_size_1, 128], 0.0, torch.float16, None)                {}
call_function  q_view         <function _host_tensor at 0x7f271836ba30>  ('q_view',)                                                                  {}
call_function  q              <function load at 0x7f26ff7e75b0>          (q_view, [block_size_0, block_size_1, slice(None, None, None)], None, None)  {}
call_function  k_in_size1     <function _get_symnode at 0x7f271836add0>  ('k_in_size1',)                                                              {}
call_function  _for_loop      <function _for_loop at 0x7f271836bd90>     (0, [0], [k_in_size1], [q, m_i, qk_scale_dev, l_i, acc])                     {}
...
call_function  _phi           <function _phi at 0x7f2718374310>          (m_i, getitem)                                                               {}
call_function  _phi_1         <function _phi at 0x7f2718374310>          (l_i, getitem_1)                                                             {}
call_function  _phi_2         <function _phi at 0x7f2718374310>          (acc, getitem_2)                                                             {}
call_function  l_i_broadcast  <function broadcast at 0x7f26ff5a9480>     (_phi_1, 2, [block_size_0, block_size_1, 128])                               {}
call_function  acc_1          aten.div.Tensor                            (_phi_2, l_i_broadcast)                                                      {}
call_function  out_           <function _host_tensor at 0x7f271836ba30>  ('out_',)                                                                    {}
call_function  store          <function store at 0x7f26ff7e5990>         (out_, [block_size_0, block_size_1, slice(None, None, None)], acc_1, None)   {}
...
module attributes {loom.tile_b = {is_reduction = false, upper_bound = 32 : index}, loom.tile_m = {is_reduction = false, upper_bound = 4096 : index}, loom.tile_n = {is_reduction = false, upper_bound = 4096 : index}} {
  func.func @attention(%k_view: memref<32x128x4096xf16>, %v_view: memref<32x4096x128xf16>, %q_view: memref<32x4096x128xf16>, %out_: memref<32x4096x128xf16>) {
    ...
    affine.parallel (%arg4, %arg5) = (0, 0) to (symbol(%3), symbol(%4)) {
      ...
      %subview = memref.subview %q_view[%10, %11, 0] [%0, %1, 128] [1, 1, 1] : memref<32x4096x128xf16> to memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>>
      ...
      %14:3 = scf.for %arg6 = %c0 to %13 step %c1 iter_args(%arg7 = %6, %arg8 = %7, %arg9 = %9) -> (tensor<?x?x1xf16>, tensor<?x?x1xf16>, tensor<?x?x128xf16>) {
        ...
        %21 = arith.cmpi ult, %20, %c4096 : index
        %22 = arith.select %21, %20, %c4096 : index
        %23 = arith.subi %22, %19 : index
        %subview_4 = memref.subview %k_view[%10, 0, %19] [%0, 128, %23] [1, 1, 1] : memref<32x128x4096xf16> to memref<?x128x?xf16, strided<[524288, 4096, 1], offset: ?>>
        %24 = bufferization.to_tensor %subview_4 : memref<?x128x?xf16, strided<[524288, 4096, 1], offset: ?>> to tensor<?x128x?xf16>
        %25 = arith.index_cast %0 : index to i64
        %26 = arith.cmpi eq, %25, %25 : i64
        ...
        %29 = linalg.batch_matmul ins(%12, %24 : tensor<?x?x128xf16>, tensor<?x128x?xf16>) outs(%28 : tensor<?x?x?xf16>) -> tensor<?x?x?xf16>
        %30 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel", "reduction"]} ins(%29 : tensor<?x?x?xf16>) outs(%6 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %out: f16):
          %50 = arith.maximumf %in, %out : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %31 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%30 : tensor<?x?x1xf16>) outs(%5 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %out: f16):
          %50 = arith.mulf %in, %cst_2 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %32 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg7, %31 : tensor<?x?x1xf16>, tensor<?x?x1xf16>) outs(%5 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.cmpf ogt, %in, %in_6 : f16
          %51 = arith.select %50, %in, %in_6 : f16
          linalg.yield %51 : f16
        } -> tensor<?x?x1xf16>
        %33 = tensor.empty(%0, %1) : tensor<?x?x32xf16>
        %34 = "loom.broadcast"(%32, %33) {dim = 2 : i64} : (tensor<?x?x1xf16>, tensor<?x?x32xf16>) -> tensor<?x?x?xf16>
        %35 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%29 : tensor<?x?x?xf16>) outs(%27 : tensor<?x?x?xf16>) {
        ^bb0(%in: f16, %out: f16):
          %50 = arith.mulf %in, %cst_2 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x?xf16>
        %36 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%35, %34 : tensor<?x?x?xf16>, tensor<?x?x?xf16>) outs(%27 : tensor<?x?x?xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.subf %in, %in_6 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x?xf16>
        %37 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%36 : tensor<?x?x?xf16>) outs(%27 : tensor<?x?x?xf16>) {
        ^bb0(%in: f16, %out: f16):
          %50 = math.exp %in : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x?xf16>
        %38 = linalg.fill ins(%cst : f16) outs(%5 : tensor<?x?x1xf16>) -> tensor<?x?x1xf16>
        %39 = linalg.generic {indexing_maps = [#map, #map1], iterator_types = ["parallel", "parallel", "reduction"]} ins(%37 : tensor<?x?x?xf16>) outs(%38 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %out: f16):
          %50 = arith.addf %in, %out : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %40 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg7, %32 : tensor<?x?x1xf16>, tensor<?x?x1xf16>) outs(%5 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.subf %in, %in_6 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %41 = linalg.generic {indexing_maps = [#map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%40 : tensor<?x?x1xf16>) outs(%5 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %out: f16):
          %50 = math.exp %in : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %42 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg8, %41 : tensor<?x?x1xf16>, tensor<?x?x1xf16>) outs(%5 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.mulf %in, %in_6 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %43 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%42, %39 : tensor<?x?x1xf16>, tensor<?x?x1xf16>) outs(%5 : tensor<?x?x1xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.addf %in, %in_6 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x1xf16>
        %44 = linalg.generic {indexing_maps = [#map, #map1, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%arg9, %41 : tensor<?x?x128xf16>, tensor<?x?x1xf16>) outs(%8 : tensor<?x?x128xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.mulf %in, %in_6 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x128xf16>
        %subview_5 = memref.subview %v_view[%10, %19, 0] [%0, %23, 128] [1, 1, 1] : memref<32x4096x128xf16> to memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>>
        %45 = bufferization.to_tensor %subview_5 : memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>> to tensor<?x?x128xf16>
        cf.assert %26, "mismatching contracting dimension"
        %46 = arith.index_cast %2 : index to i64
        %47 = arith.cmpi eq, %46, %46 : i64
        cf.assert %47, "mismatching contracting dimension"
        %48 = linalg.batch_matmul ins(%37, %45 : tensor<?x?x?xf16>, tensor<?x?x128xf16>) outs(%9 : tensor<?x?x128xf16>) -> tensor<?x?x128xf16>
        %49 = linalg.generic {indexing_maps = [#map, #map, #map], iterator_types = ["parallel", "parallel", "parallel"]} ins(%48, %44 : tensor<?x?x128xf16>, tensor<?x?x128xf16>) outs(%8 : tensor<?x?x128xf16>) {
        ^bb0(%in: f16, %in_6: f16, %out: f16):
          %50 = arith.addf %in, %in_6 : f16
          linalg.yield %50 : f16
        } -> tensor<?x?x128xf16>
        scf.yield %32, %43, %49 : tensor<?x?x1xf16>, tensor<?x?x1xf16>, tensor<?x?x128xf16>
      }
      ...
      %subview_3 = memref.subview %out_[%10, %11, 0] [%0, %1, 128] [1, 1, 1] : memref<32x4096x128xf16> to memref<?x?x128xf16, strided<[524288, 128, 1], offset: ?>>
